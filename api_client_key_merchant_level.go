...
// ClientKeyMerchantLevelApiService ClientKeyMerchantLevelApi service
type ClientKeyMerchantLevelApiService service

type ApiPostMerchantsMerchantIdApiCredentialsApiCredentialIdGenerateClientKeyRequest struct {
	ctx context.Context
	ApiService *ClientKeyMerchantLevelApiService
	merchantId string
...
func (a *ClientKeyMerchantLevelApiService) PostMerchantsMerchantIdApiCredentialsApiCredentialIdGenerateClientKeyExecute(r ApiPostMerchantsMerchantIdApiCredentialsApiCredentialIdGenerateClientKeyRequest) (*GenerateClientKeyResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClientKeyMerchantLevelApiService.PostMerchantsMerchantIdApiCredentialsApiCredentialIdGenerateClientKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchants/{merchantId}/apiCredentials/{apiCredentialId}/generateClientKey"
