...
func (dst *ScheduleTerminalActionsRequestActionDetails) UnmarshalJSON(data []byte) error {
	...
	err = newStrictDecoder(data).Decode(&dst.InstallAndroidAppDetails)
	if err == nil {
		jsonInstallAndroidAppDetails, _ := json.Marshal(dst.InstallAndroidAppDetails)
		if string(jsonInstallAndroidAppDetails) == "{}" { // empty struct
	...
	err = newStrictDecoder(data).Decode(&dst.InstallAndroidCertificateDetails)
	if err == nil {
		jsonInstallAndroidCertificateDetails, _ := json.Marshal(dst.InstallAndroidCertificateDetails)
		if string(jsonInstallAndroidCertificateDetails) == "{}" { // empty struct
	...
	err = newStrictDecoder(data).Decode(&dst.ReleaseUpdateDetails)
	if err == nil {
		jsonReleaseUpdateDetails, _ := json.Marshal(dst.ReleaseUpdateDetails)
		if string(jsonReleaseUpdateDetails) == "{}" { // empty struct
	...
	err = newStrictDecoder(data).Decode(&dst.UninstallAndroidAppDetails)
	if err == nil {
		jsonUninstallAndroidAppDetails, _ := json.Marshal(dst.UninstallAndroidAppDetails)
		if string(jsonUninstallAndroidAppDetails) == "{}" { // empty struct
	...
	err = newStrictDecoder(data).Decode(&dst.UninstallAndroidCertificateDetails)
	if err == nil {
		jsonUninstallAndroidCertificateDetails, _ := json.Marshal(dst.UninstallAndroidCertificateDetails)
		if string(jsonUninstallAndroidCertificateDetails) == "{}" { // empty struct
