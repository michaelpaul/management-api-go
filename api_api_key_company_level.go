...
type ApiPostCompaniesCompanyIdApiCredentialsApiCredentialIdGenerateApiKeyRequest struct {
	ctx context.Context
	ApiService *APIKeyCompanyLevelApiService
	companyId string
...
func (a *APIKeyCompanyLevelApiService) PostCompaniesCompanyIdApiCredentialsApiCredentialIdGenerateApiKeyExecute(r ApiPostCompaniesCompanyIdApiCredentialsApiCredentialIdGenerateApiKeyRequest) (*GenerateApiKeyResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "APIKeyCompanyLevelApiService.PostCompaniesCompanyIdApiCredentialsApiCredentialIdGenerateApiKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/companies/{companyId}/apiCredentials/{apiCredentialId}/generateApiKey"
